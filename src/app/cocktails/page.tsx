...
const cocktails = [
  {
    ...
    spirit: 'AETHER Gin No. 1',
    difficulty: 'Easy',
    time: '5 min',
    description: 'A refreshing blend of Ethiopian citrus and Mediterranean herbs.',
    ingredients: ['2 oz AETHER Gin No. 1', '1 oz fresh lemon juice', '0.5 oz honey syrup', '2 oz tonic water', 'Garnish: lemon twist & rosemary'],
  ...
  },
  {
    ...
    spirit: 'AETHER Gin Reserve',
    difficulty: 'Intermediate',
    time: '3 min',
    description: 'A bold, aged take on the classic Italian aperitivo.',
    ingredients: ['1 oz AETHER Gin Reserve', '1 oz Campari', '1 oz sweet vermouth', 'Garnish: orange peel'],
  ...
  },
  {
    ...
    spirit: 'AETHER XO Cognac',
    difficulty: 'Intermediate',
    time: '5 min',
    description: 'Elegant and balanced with a hint of Ethiopian spice.',
    ingredients: ['2 oz AETHER XO Cognac', '1 oz fresh lemon juice', '0.5 oz simple syrup', '1 egg white', 'Garnish: Angostura bitters'],
  ...
  },
  {
    ...
    spirit: 'AETHER Midnight',
    difficulty: 'Advanced',
    time: '7 min',
    description: 'A sophisticated after-dinner drink with espresso notes.',
    ingredients: ['1.5 oz AETHER Midnight', '1 oz coffee liqueur', '0.5 oz fresh espresso', '0.25 oz vanilla syrup', 'Garnish: coffee beans'],
  ...
  },
  {
    ...
    spirit: 'AETHER Signature Blend',
    difficulty: 'Easy',
    time: '2 min',
    description: 'Light, bubbly, and perfect for celebrations.',
    ingredients: ['2 oz AETHER Signature Blend', '3 oz prosecco', '2 oz soda water', 'Garnish: fresh berries & mint'],
  ...
  },
  {
    ...
    ingredients: ['2 oz AETHER VSOP', '0.5 oz elderflower liqueur', '2 oz ginger beer', 'Garnish: candied ginger'],
